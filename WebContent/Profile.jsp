    ...
    <div class="container" style="padding: 30px;">
        ...
        try
        {
			...
			else
			{
				...
				%>
				<img src="images/<%=img%>" id="f1" class="rounded-circle avatar-xl img-thumbnail" style="width: 150px;height: 150px;" alt="profile-image">
		  ...
		  <form action="change"  id="myform" method="post" enctype="multipart/form-data" >
		      <input type="file" id="profile"  name="file1"  class="file1" style="visibility: hidden" onchange="javascript:fun1(event)" />
		   	<label for="profile" >  	<img src="images/cam.png" style="position:absolute; left:710px;height:30px; width:30px; top:230px;">
	</label>
					...
					<div class="col-md-4" onclick="location.href='notedesc.jsp?nid=<%=id%>';" style="cursor: pointer;">
		                <div class="card">
		                    <div class="card-body pb-5">
		                        <div class="pt-4 pb-5">
		                            <img src="images/<%=img1 %>" class="img-fluid img-center" style="height: 150px;" alt="Illustration" />
		                        </div>
		...
		{
			e.printStackTrace();
			System.out.println("Error notes fetching : "+e.getMessage());
		}
		...
		try{
			...
			ResultSet rs=st.executeQuery("select * from buyer where buyerid="+uid+"");
			//rs.last();
		//	int rows = rs.getRow();
			if(rs.next())
			{
				...
				do
				{
					...
					while(rs1.next())
					{
						...
						<div class="col-md-4" onclick="location.href='YOUR-URL-HERE';" style="cursor: pointer;">
			                <div class="card">
			                    <div class="card-body pb-5">
			                        <div class="pt-4 pb-5">
			                            <img src="images/<%=img1 %>" class="img-fluid img-center" style="height: 150px;" alt="Illustration" />
