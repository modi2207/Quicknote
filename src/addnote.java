	...
	//	String name;
		...
		for(FileItem it:item)
		{
		   ...
		   else
		   {
			   if(j==3)
			   {
				   File f=new File("C:/javaworkspace19/Quicknote/WebContent/notes/" + it.getName());
				   if(f.exists())
				   {
				   ...
				   {
				   it.write(new File("C:/javaworkspace19/Quicknote/WebContent/notes/" + it.getName()));
				   }
				   info[i]=it.getName();
			   ...
			   {
				   File f=new File("C:/javaworkspace19/Quicknote/WebContent/images/" + it.getName());
				   if(f.exists())
				   {
				   }
				   else
