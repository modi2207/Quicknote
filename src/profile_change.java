...
public class profile_change extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
		     	   File f=new File("C:/javaworkspace19/Quicknote/WebContent/images/profile/" + it.getName());
				   if(f.exists())
				   {
				   ...
				   {
				   it.write(new File("C:/javaworkspace19/Quicknote/WebContent/images/profile/" + it.getName()));
				   }
				   info=it.getName();
